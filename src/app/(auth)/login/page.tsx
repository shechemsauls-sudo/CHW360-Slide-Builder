            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <a href="/forgot-password" className="text-xs font-medium hover:underline" style={{ color: "#C9725B" }}>
                    Forgot password?
                  </a>
                </div>
                <Input
        ...
        {mode === "claim" && (
          <>
            <form onSubmit={handleClaimAccount} className="space-y-4">
              <div>
                <label htmlFor="claim-email" className="block text-sm font-medium" style={{ color: "#2D5A5A" }}>Email</label>
                <Input
                  id="claim-email"
                  type="email"
                  value={email}
