...
| Date | Change |
|------|--------|
| 2026-03-08 | Added client API keys (YouTube, xAI, Stability, Replicate, Leonardo) to env + Vercel |
| 2026-03-08 | Supabase keep-alive cron (pg_cron + pg_net, pings chw360.com every 4 days) |
| 2026-03-08 | Fixed Vercel RESEND_API_KEY (removed surrounding quotes) |
| 2026-02-19 | API key setup guide (PDF) for client — YouTube, xAI/Grok, Stability, Replicate, Leonardo |
| 2026-02-19 | Client review meeting — iterative polish phase, theme/image/rendering feedback |
